        ...
        <div className="card p-3 col-6">
            ...
            <div className="mt-3">
                {isOwner ?
                    ...
                    :
                    <div>
                        <UsernameWithData id={task.owner}/> is the owner of this task.
                    </div>}
            </div>
            <div className="mt-2">
                {comments.map(comment=>(
                    <div key={comment.id}>
                        <UsernameWithData id={comment.owner}/> : {comment.content}
                    </div>
                ))}
            </div>
...
function mapStateToData(state,ownProps){
...
export const TaskDetailWithData = connect(mapStateToData,mapDispatchToProps)(TaskDetail);